...
<div class="page-main w-100 d-flex justify-content-center mt-5">
		...
		<frm:form action= "${pageContext.request.contextPath }/api/reservation/createReservation" method = "post" modelAttribute="reservation" >
			<table class="table w-100">
				...
				<tbody class="reservation-body">
					...
					<td>CheckedIn</td>
						<td>
							<frm:radiobutton checked= "true" class = 'w-25' value="false" path='checkedIn' label='NO'/>
						</td>
					</tr>
	...
	<div class="bg-dark text-white flex-grow-1  ">
		<span >Search By Flights: </span>
	</div>
	

	<div class='table-reservation d-flex flex-column'>
