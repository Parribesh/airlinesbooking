...
<div class="page-main w-100 d-flex justify-content-center">
	...
	<div class="form-container d-flex justify-content-center float-left">
	
		<div class='filter-main flex-grow-1 d-flex flex-column align-items-center'>
			<sec:authorize access="hasAuthority('USER')">
				<div class='filter-title w-100 d-flex justify-content-start text-white'>
					...
					<table class="w-100 p-4">
						<tbody class="w-75 p-4">
							...
							<tr>
								...
								<td><frm:errors path="flightNumber"/></td>
							</tr>
							<tr>
								...
								<td><frm:errors path="departureAirport"/></td>
							</tr>
							...
							<tr>
								...
								<td><frm:errors path="arrivalAirport"/></td>
							</tr>	
	...
	<div class = 'table-container flex-grow-1 mt-3'>
		<div class='d-flex align-items-center text-muted p-0'>
			<h5 class='m-0'>${message}</h5>:
			<h5 class='m-0'>SearchResults</h5>
			<h5 class='m-0'>${flights.size()}</h5>	
		</div>
		<div class=''>
