			...
			<table class=" table p-4">
				...
				<tbody class="p-4">
					<tr>
						...
						<td><frm:errors path="passengerId"/></td>
					</tr>
					<tr>
						<td class='font-weight-bold' ><div>First Name:</div> <div class='text-danger'><frm:errors path="firstname"/></div> </td>
						
						<td class='font-weight-bold'><div>Last Name:</div> <div class='text-danger'><frm:errors path="lastname"/></div> </td>
					...
					<tr class= ''>
						<td class='font-weight-bold'><div>Email:</div> <div class='text-danger'><frm:errors path="email"/></div> </td>
						<td class='font-weight-bold'><div>Gender:</div> <div class='text-danger'><frm:errors path="gender"/></div> </td>
					...
					<tr>
						<td class='font-weight-bold'><div>Phone:</div><div class='text-danger'><frm:errors path="phone"/></div> </td>
						<td><frm:input class='form-control ' value = "${p.getPhone() }" type = "text" path="phone"/></td>
						
					</tr>
					
					<tr>
						<td class='font-weight-bold'><div>DoB: </div><div class='text-danger'><frm:errors path="dob"/></div></td>
						<td><frm:input class='form-control' value = "${p.getDob() }" type = "date" path="dob"/></td>
						
					</tr>	
					
					<tr>
						<td class='font-weight-bold'><div>Identification:</div><div class='text-danger'><frm:errors path="identificationType"/></div> </td>
						<td>
					...
					<tr>
						<td class='font-weight-bold'><div>Flight Number:</div><div class='text-danger'> <frm:errors path="flight"/></div></td>
						<td>
